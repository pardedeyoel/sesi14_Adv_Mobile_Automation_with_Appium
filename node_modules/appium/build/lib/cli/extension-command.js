...
class ExtensionCliCommand {
    ...
    async installViaNpm({ installSpec, pkgName, pkgVer, installType }) {
        ...
        try {
            const { pkg, installPath } = await (0, utils_1.spinWith)(this.isJsonOutput, msg, async () => {
                const { pkg, installPath } = await support_1.npm.installPackage(appiumHome, installStr, {
                    pkgName,
                    installType,
                });
            ...
            await injectAppiumSymlink.bind(this)(path_1.default.join(installPath, 'node_modules'));
...
async function injectAppiumSymlink(dstFolder) {
    ...
    try {
        ...
        const symlinkPath = path_1.default.join(dstFolder, path_1.default.basename(appiumModuleRoot));
        ...
        this.log.info(`Cannot create a symlink to the appium module '${appiumModuleRoot}' in '${dstFolder}'. ` +
